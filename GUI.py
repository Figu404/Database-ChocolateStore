...
def start(cursor, cnx):
    def customer(personal_code):
        ...
        label = tk.Label(nam, text= "Find the cheapest chocolate", padx=10, pady=10)
        ...
        label = tk.Label(nam, text= "Find all your ratings", padx=10, pady=10)
        ...
        label = tk.Label(nam, text= "Add a new score", padx=10, pady=10)
    ...
    def store_personal():
        ...
        label.grid(row=1, column=1)
        button = tk.Button(store, text="SHOW", command=lambda : sql.cheapest_chocolate(cursor, stor.get()))
